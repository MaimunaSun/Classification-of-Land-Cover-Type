...
This project classifies forest land cover types using **machine learning** and compares the performance of **Gaussian Naive Bayes** and **Multi-Layer Perceptron (MLP) Neural Network** classifiers.
...
- Both models used to predict `Cover_Type` for a separate test set  
...
| MLP Neural Network | 81% | Handles complex interactions, better overall performance |

## Technologies Used
- Python, Pandas, NumPy, Matplotlib, Scikit-learn  

## Key Takeaways
- **MLP outperforms Naive Bayes** significantly for this dataset  
- Visualization of class frequencies helps understand **class imbalance**  
- Demonstrates a clear case of **shallow vs deep learning models** in practice
